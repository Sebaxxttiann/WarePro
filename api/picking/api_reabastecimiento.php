...
try {
    ...
    $sql = "SELECT 
                ...
                p.created_at,
                pr.id_material
            FROM pi_reabastecimiento p
            LEFT JOIN productos pr ON p.descripcion_material COLLATE utf8mb4_unicode_ci = pr.material COLLATE utf8mb4_unicode_ci
            WHERE p.operacion_id = " . (int)getOperacionActiva() . "
